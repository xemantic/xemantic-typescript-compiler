...
**As of 2026-04-23 (post-16.4fj recon, 8291 passing)**: pool fully drained — `find_candidates.py --fresh` returns only 4 candidates, all blocker-adjacent or multi-piece coordinated fixes. See the latest "Session 2026-04-23 (post-16.4fj recon) explored-but-skipped" entry above for the specific candidates examined this recon session (intersection elaboration, pathMapping rootDir, didYouMean TS6212/TS6213, complicatedPrivacy two-gap). Next gains require either a blocker #1 sub-step or a coordinated new-diagnostic family implementation.

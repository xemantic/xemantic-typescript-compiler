...
4. Verify no regressions from the **7,377 currently passing tests**
...
- **No regressions** — the 7,377 currently passing tests must continue to pass after every change.

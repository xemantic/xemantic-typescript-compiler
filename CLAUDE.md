...
4. Verify no regressions from the **5,624 currently passing tests**
...
- **No regressions** — the 5,624 currently passing tests must continue to pass after every change.

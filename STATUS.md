...
**Phase 4 — Checker buildout.** 8,947 / 10,078 tests passing (~88.78%). _Round 44 (2026-05-25, in-progress) — 6 net-zero broadening commits + 1 doc. iter1 checkPropertyOverrideInStatement reach ClassExpression in arrow/fn bodies; iter2 checkPropertyInitInStatements ClassDeclaration member recursion; iter3 checkConstructorParamInInitializersInStatements ClassDeclaration member recursion; iter4 CLAUDE.md gotcha iter14-pattern; iter5 multi-level optional-chain receiver narrowing; iter6 checkMultiBaseInStatement ClassDeclaration member recursion. All net-zero confirming round 43 iter14's flip was a singleton._

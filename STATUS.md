...
**(P18.9) — THE RxJS CORE RUNG COMPILES, THEN ITS CENSUS HALVES, THEN A PARSER DEFECT, THEN ALL 250 rxjs FILES AND typescript.d.ts COMPILE, 16,867 → 17,117 / 0 / 3 (2026-09-02).** (EXT.11a):
...
the `= definedExternally` optionality rung is (EXT.23).

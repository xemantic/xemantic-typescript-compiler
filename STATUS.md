...
**Phase 4 — Checker buildout.** 8,992 / 10,078 tests passing (~89.23%). _Round 51 iter20 (2026-05-27, **B85.1a optional-param `| undefined` wrap in `checkFunctionBody`'s `currentLocalTypes`**) — net-zero infra; mirror of `resolveUncalledParamType` (Checker.kt:25081). Gate: `param.questionToken && param.initializer == null`. Unblocks B85.1d (TS2322 for `obj[key] = optionalParam` against `string`-typed index sig — `crashRegressionTest_ts` target). Final iter of 20-iter round 51 session: +9 net flips, 8983 → 8992; 5 code-flip iters, 14 net-zero infra iters._

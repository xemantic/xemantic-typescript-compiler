...
**Phase 4 — Checker buildout.** 8,405 / 10,078 tests passing (~83%).
...
that vein continues to yield +1 per session via re-examining previously-
skipped tests after each round of infrastructure changes.

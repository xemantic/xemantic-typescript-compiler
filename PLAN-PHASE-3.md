...
- **Session 2026-03-28**: TS2663 parameter property refs investigated, reverted to TS2301 (context-dependent — TS2663 only fires in multi-file contexts where name resolves ONLY to parameter property). Parser improvements: TS1127 for Unknown tokens, TS1005 for CloseParen at expression start.

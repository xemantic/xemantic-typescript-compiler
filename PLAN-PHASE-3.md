...
- **10,077 tests**, 7,494 passing (74.4%), 2,583 failing
- **Session 2026-03-23e**: +74 tests: TS2322 expanded — TypeReference support (simple + generic), ReturnStatement checking, strict null checks, type parameter elaboration chain ("could be instantiated with arbitrary type"). Fixes: Kotlin init order for `strictNullChecks`, TS2322 suppression when TS2304/TS2314 exists, generic TypeRef formatting (Name<Arg1, Arg2>), ArrayType display, type param threading through traversal

...
- **10,077 tests**, 7,496 passing (74.4%), 2,581 failing
- **Session 2026-03-23e**: +76 tests: TS2322 expanded — TypeReference (simple + generic), ReturnStatement checking, strict null checks, type parameter elaboration chain, UnionType support. Fixes: Kotlin init order for `strictNullChecks`, TS2322 suppression when TS2304/TS2314 exists, generic TypeRef formatting, ArrayType display, type param threading, union member assignability checking

...
**Round 424 (2026-07-06) — M3.4/M1.12: six flow-narrowing burn-down fixes from the round-423
residual triage. Self-compile (compiler profile) 1,707 → 1,691 → 1,687 → 1,683 → 1,680 → 1,672
(−35; TS2339 104 → 78, TS18048 5 → 1, TS2322 756 → 751); every step's by-site diff STRICTLY
removals; suite 9,223 → 9,248 (+25 local, 0 regressions); 6 fix commits, 6 local test files
(25 tests).**

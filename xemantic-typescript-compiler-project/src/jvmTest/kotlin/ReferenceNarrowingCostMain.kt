...
/**
 * (INC.44) What the spelling-narrowed reference sweep COSTS, per named symbol, both
 * arms in one process.
 *
 ...
 *   com.xemantic.typescript.compiler.project.ReferenceNarrowingCostMainKt \
...
fun main(args: Array<String>) {
    ...
    println("caret | partition | narrowMs (first, median of 3) | wholeMs | ratio | hits")
    for (spec in args.drop(1)) {
        ...
        val partition = project.narrowedSweepFiles(target, offset)
